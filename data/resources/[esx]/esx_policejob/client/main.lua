...
--		table.insert(elements, {label = '🚨 [DIVISION - SWAT] 🚨', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'unitgang_wear' or
