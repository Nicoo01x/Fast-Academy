...
RegisterServerEvent('esx_drugs:pickedspainUpCannabis')
AddEventHandler('esx_drugs:pickedspainUpCannabis', function()
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_drugs:processspainCannabis')
AddEventHandler('esx_drugs:processspainCannabis', function()
