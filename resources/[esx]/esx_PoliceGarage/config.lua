...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = { 
			{x=626.8054, y=24.9838, z=87.8975},
			{x=610.7286, y=30.3963, z=89.5488},
		}
	}
}
...
Config.CarGarageName = "Garage de la policía"
...
Config.PoliceCarMarkerColor = {  r = 255, g = 0, b = 0, a = 100 } 			-- rgba color of the marker
Config.PoliceCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "Presione ~r~[E] ~s~para abrir el ~r~Garage."			-- set your desired text here
...
Config.HeliDraw3DText = "Presione [E] para abrir el Garage."		-- set your desired text here
...
Config.BoatDraw3DText = "Presione [E] para abrir el Garage."		-- set your desired text here


-- Police Cars:
Config.PoliceVehicles = {
		{ model = '', label = '-----COCHES-----'},
		{ model = 'WRbmwm4', label = 'Bmw M4 Policial'},
		{ model = 'WRcypher', label = 'Bmw M2 Policial'},
		{ model = 'WRdubsta3', label = 'Dubsta 4x4 Policial'},
		{ model = 'WRtailgater2', label = 'Audi Policial'},
		{ model = '', label = '-----MOTOS-----'},		
		{ model = 'WRafricat', label = 'Africat'},		
}
...
-- Commands:
Config.RepairCommand = 'repairveh'
Config.CleanCommand = 'cleanveh'

-- Menu Labels & Titles:
Config.LabelStoreVeh = "Coloque el vehículo en el Garage"
Config.LabelGetVeh = "Escoge un vehículo del Garage"
...
Config.VehicleParked = "¡El vehículo está en el Garage!"
Config.NoVehicleNearby = "¡No tienes vehículo!"
Config.CarOutFromPolGar = "¡Coche retirado del Garage!"
Config.HeliOutFromPolGar = "¡Helicóptero retirado del Garage!"
...
Config.VehicleLoadText = "Espere a que se genere el vehículo"			-- text on screen when vehicle model is being loaded
